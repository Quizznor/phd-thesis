...
photon_flux_file_str = f'{PYTHON_DICTIONARY_DIR}photon-flux-dict_2023-10-06_2023-10-07.pickle'
gps_second_file_str = f'{PYTHON_DICTIONARY_DIR}gps-second-dict_2023-10-06_2023-10-07.pickle'
calibration_constants_file_str = f'{PYTHON_DICTIONARY_DIR}calibration-constants-dict_2023-10-06_2023-10-07.pickle'
...
calibration_constants_dict = load_python_dictionary_from_str(calibration_constants_file_str)
...
nearest_gps_second_index, min_sep = find_nearest_index(gps_second_dict[eye_name][tel_name]['gps-second'], desired_gps_second)

nearest_gps_second = gps_second_dict[eye_name][tel_name]['gps-second'][nearest_gps_second_index]

nearest_photon_flux = photon_flux_dict[eye_name][tel_name]['photon-flux'][nearest_gps_second_index]

nearest_calibration_constants = calibration_constants_dict[eye_name][tel_name]['calibration-constants'][nearest_gps_second_index]
...
print(f'calibration constant at pixel id {pixel_id}: {nearest_calibration_constants[pixel_id-1]}')
