...
int main(int argc, char *argv[]) 
{
  ...
  ofstream outSSDFile("/cr/data01/filip/Data/daqIntegrationTests/v1/t3_histos.ssd", ios_base::trunc);
  ofstream outWCDFile("/cr/data01/filip/Data/daqIntegrationTests/v1/t3_histos.wcd", ios_base::trunc);
  ...
  for (pos = input.FirstEvent(); pos < input.LastEvent(); pos = input.NextEvent())
  {
    ...
    for (const IoSdStation& station : stations)
    {
      ...
      std::cout << calibrationHistograms << " " << calibrationHistograms->type << std::endl;
