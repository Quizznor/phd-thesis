...
\begin{figure}[t]
  ...
  \subref{fig:fd-schematic} A schematic view inside a single telescope, or bay, 
	of an \FD building, adopted from \cite{}.\todo{find source}}
...
In order to track the relative drift between absolute calibration campaigns,
an LED located in the center of the mirror shoots a known amount of light
directly at the camera. It is performed twice each night, once before \DAQ, and 
once more after \DAQ.
